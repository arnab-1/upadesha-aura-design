        ...
        <div className="max-w-3xl mx-auto text-center">
          <div className="mb-6">
            <img 
              src="/placeholder.svg" 
              alt="Upadesha Symbol" 
              className="w-20 h-20 mx-auto mb-4 opacity-90 animate-float filter brightness-110"
            />
          </div>
          ...
          <a 
            href="#consult" 
            className="inline-block rounded-full bg-gradient-to-r from-purple-600 to-blue-500 hover:from-purple-700 hover:to-blue-600 px-8 py-3 text-lg font-medium text-white shadow-2xl transition-all hover:scale-105 animate-glow"
          >
            Consult Now
          </a>
        </div>
